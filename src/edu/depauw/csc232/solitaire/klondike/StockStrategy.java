...
/**
 * This PileStrategy encapsulates the rules for the stock pile in Klondike.
 * The only interaction allowed is to click on the stock, which deals one card
 * into the waste pile. If the stock is empty, then the waste pile is turned
 * over to replenish the stock.
 * 
 * @author bhoward
 */
public class StockStrategy implements PileStrategy {
	/**
	 * Construct the StockStrategy given a reference to the associated waste pile.
	 * 
	 * @param waste
	 */

...
public class CardCollection {
  ...
  /**
   * Add all 13 cards of the given suit to this collection, in order from Ace to
   * King.
   * 
   * @param suit
   */
  ...
  /**
   * Shuffle this collection into a random order, where all orderings are equally
   * likely.
   */
  public void shuffle() {
  ...
  /**
   * Look at the card at the given index in this deck, where position 0 is at the
   * bottom of the deck. If there is no such card, throws
   * {@link NoSuchElementException}.
   * 
   * @param index position of desired card, starting from 0 at the bottom
  ...
  /**
   * Look at the bottommost card of this collection. If this collection is empty,
  ...
  /**
   * Flip over the topmost card of this collection. If this collection is empty,
   * throws {@link NoSuchElementException}.
   */
  public void flipTop() {
    getTop().flip();

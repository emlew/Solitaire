...
public class Packet extends CardStack {
	...
	/**
	 * Notify this packet that it has been dropped on the given pile. The cards are
	 * added to the target pile, and the origin is notified of the drag completion.
	 * 
	 * @param target the target of the drop
	 * @param event  the mouseReleased event for the drop
	 */
	...
	/**
	 * Notify this packet that its current drag motion has been cancelled. The cards
	 * are returned to the origin pile.
	 * 
	 * @param event the mouse event that cancelled the drag
	 */
